...
export default function HomePage() {
  ...
  const approvedVideosQuery = query(videosRef, limit(20));
  ...
  return (
    <div className="space-y-12 animate-fade-in">
      ...
      <section>
        <h2 className="text-2xl font-bold font-headline mb-4">All Videos</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 animate-fade-in">
          ...
          {hasMore && !loading && (
            <div ref={loadMoreRef} className="col-span-full flex justify-center py-4">
              <div className="text-muted-foreground">Loading more videos...</div>
            </div>
          )}
