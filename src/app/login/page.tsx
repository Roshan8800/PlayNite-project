    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md" role="main" aria-labelledby="login-title">
        <CardHeader className="text-center">
          <CardTitle id="login-title" className="text-2xl font-bold">Welcome Back</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative" role="separator" aria-label="Alternative sign-in options">
          ...
          <nav aria-label="Account options">
            ...
            <div className="text-center">
              <Link
                ...
                className="text-sm text-muted-foreground hover:text-primary hover:underline focus:outline-2 focus:outline-primary"
              >
