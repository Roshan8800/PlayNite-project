...
export const users: User[] = [
  { uid: '1', name: 'Alex Johnson', email: 'alex@example.com', avatarUrl: getImage('avatar-1').url, role: 'Admin', joinedDate: '2023-01-15', status: 'Active' },
  { uid: '2', name: 'Maria Garcia', email: 'maria@example.com', avatarUrl: getImage('avatar-2').url, role: 'User', joinedDate: '2023-02-20', status: 'Active' },
  { uid: '3', name: 'James Smith', email: 'james@example.com', avatarUrl: getImage('avatar-3').url, role: 'User', joinedDate: '2023-03-10', status: 'Active' },
  { uid: '4', name: 'Priya Patel', email: 'priya@example.com', avatarUrl: getImage('avatar-4').url, role: 'User', joinedDate: '2023-04-05', status: 'Inactive' },
  { uid: '5', name: 'Chen Wang', email: 'chen@example.com', avatarUrl: getImage('avatar-5').url, role: 'Admin', joinedDate: '2023-05-21', status: 'Active' },
];
